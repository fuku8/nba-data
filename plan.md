...
- **4マップの取捨**（検証: `_ai_workspace/reports/2026-09-25-選手ページへの選手マップ掲載の検証.md`）: USG%×TS% は相関 +0.02・四象限ほぼ均等で全員に有効。3PA×3P% は 3PA≥4 の該当者（162人）にのみ有効 → **段階2**で該当者だけに追加。STL×BLK は STL≤1.0 かつ BLK≤0.5 に61%が固まり個人ページでは弱い → 見送り（/leaders の型分けとしては維持）
